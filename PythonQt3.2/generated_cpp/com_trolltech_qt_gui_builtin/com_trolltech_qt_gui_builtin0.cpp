...
QBitmap*  PythonQtWrapper_QBitmap::operator_assign(QBitmap* theWrappedObject, QBitmap  arg__1)
{
...
QMatrix* PythonQtWrapper_QMatrix::new_QMatrix(QMatrix  arg__1)
{ 
return new QMatrix(arg__1); }
...
QRegion* PythonQtWrapper_QRegion::new_QRegion(QRegion  arg__1)
{ 
return new QRegion(arg__1); }
